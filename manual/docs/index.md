...
-   Multiwii XML. The mission file format used by inav mission planners such as [mwp](https://github.com/stronnag/mwptools), ezgui, mission planner for inav and the inav configurator.
